...
const FIELDS: { key: string; label: string; type: 'text' | 'number' | 'date' | 'select' }[] = [
  ...
  { key: 'percepcion_iva',       label: 'Perc. IVA',         type: 'number' },
  { key: 'percepcion_ingresos_brutos', label: 'Perc. IIBB',  type: 'number' },
  { key: 'impuestos_internos',   label: 'Imp. Internos',     type: 'number' },
