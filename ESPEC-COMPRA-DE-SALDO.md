...
*Versión 3.2 · 2026-09-19 (v3: decisiones del director incorporadas — bono, cotización al comprar, sin redondeo · v3.1: fase 0 cerrada y corrección del índice único · v3.2: fase 5 en tres partes, vigilancia en dos capas, mínimo US$ 10) · Estado: **aprobada; fases 0 a 4, 5.1 y 5.2 cerradas; sigue la 5.3 (editor de precios del director)** · Zona cerrada (facturación y Mercado Pago): cada fase necesita OK explícito*
